...
SampleSheet <- list.files(paste0(data_dir, runs), pattern= "SampleSheet", full.names = TRUE)
runParameters <- list.files(paste0(data_dir, runs), pattern= "[Rr]unParameters.xml", full.names = TRUE)
