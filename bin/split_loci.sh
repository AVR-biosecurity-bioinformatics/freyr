...
# save as .csv 
echo "split_loci,$7,$8,$5,$R1_IN,$R2_IN" > ${7}_${5}_readsin.csv # columns: process; sample_id; fcid; pcr_primers; fwd_in; rev_in
...
# save as .csv 
echo "split_loci,$7,$8,$5,$R1_OUT,$R2_OUT" > ${7}_${5}_readsout.csv # columns: process; sample_id; fcid; pcr_primers; fwd_out; fwd_out
