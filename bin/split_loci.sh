...
# save as .csv 
echo "split_loci,$7,$8,$5,$R1_IN,$R2_IN" > readsin.csv # columns: process; sample_id; fcid; pcr_primers; fwd_in; rev_in
...
# save as .csv 
echo "split_loci,$7,$8,$5,$R1_OUT,$R2_OUT" > readsout.csv # columns: process; sample_id; fcid; pcr_primers; fwd_out; fwd_out
